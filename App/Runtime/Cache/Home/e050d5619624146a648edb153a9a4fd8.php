    ...
    <div class="container">
        <div class="row">
            <section id="page-sidebar" class="pull-left col-md-8">
				<?php if(is_array($news)): foreach($news as $key=>$val): ?><article class="blog-post blog-post-news">
						<div class="row ">
							<div class="col-md-12">
								<h3 class="post-title"><a href="<?php echo U('news');?>?id=<?php echo ($val['id']); ?>"><?php echo ($val['title']); ?></a></h3>
								<ul class="post-meta">
									<li><i class="fa fa-calendar"></i><?php echo ($val['time']); ?></li>
								</ul>
								<div class="post-content">
									...
									<p><a href="<?php echo U('News/news');?>?id=<?php echo ($val['id']); ?>" class="btn btn-large btn-welcome post-content-news"><i class="fa fa-chevron-right "></i>查看详情</a></p>
								</div>
							</div>
						</div>
					</article><?php endforeach; endif; ?>	
                <!--pagination-->
				<div class="row pagination-top" style="text-align:center">
            ...
            <aside id="sidebar" class="col-md-4">
                <section>
					...
					<?php if(is_array($list)): foreach($list as $key=>$val): ?><ul class="icons ul-list">
							<li><a href="<?php echo U('News/news');?>?id=<?php echo ($val['id']); ?>"><?php echo ($val['title']); ?></a></li>
